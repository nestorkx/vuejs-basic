      ...
      <section class="hero">
        <div class="hero-body">
          <div class="container">
            ...
            <div class="is-two-thirds is-paddingless">
    ...
    <section class="section">
      <div class="container">
        <div class="columns pd is-desktop">
          ...
          <div class="column">
            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Architecto at autem consequatur delectus harum in magni minus mollitia quasi sed? Corporis, distinctio facere impedit ipsam nemo odit provident quo soluta..</p>
          </div>
        </div>
      </div>
...
export default {
  ...
  data() {
    return {
      ...
      subheading: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad architecto at autem consequatur, dolorem dolorum eligendi error explicabo illum ipsum nam odit quae quam quasi tempore? Aliquid earum, excepturi. Cumque.'
    }
  }
}
</script>
